...
const SingleTestimonial = ({ testimonial }: { testimonial: Testimonial }) => {
  ...
  return (
    <div className="w-full px-4 md:w-1/2 lg:w-1/3">
      <div
        className="rounded-xl bg-white px-4 py-[30px] shadow-testimonial sm:px-[30px] hover:shadow-lg transition-all duration-300"
        data-wow-delay=".1s"
      >
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-red-500 text-xs">{designation}</p>
          </div>
        </div>
      </div>
    </div>
